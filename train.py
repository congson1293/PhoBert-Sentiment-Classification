...
parser.add_argument('--config_path', type=str, default="/mnt/data/nobita/PhoBERT_base_transformers/config.json")
parser.add_argument('--rdrsegmenter_path', type=str, default='/mnt/data/nobita/vncorenlp/VnCoreNLP-1.1.1.jar')
parser.add_argument('--pretrained_path', type=str, default='/mnt/data/nobita/PhoBERT_base_transformers/model.bin')
...
parser.add_argument('--bpe-codes', default="/mnt/data/nobita/PhoBERT_base_transformers/bpe.codes",type=str, help='path to fastBPE BPE')
